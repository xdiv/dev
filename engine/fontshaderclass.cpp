...
bool FontShaderClass::InitializeShader(ID3D10Device* device, HWND hwnd, WCHAR* filename)
{
	...
	//The second change is the pointer to the pixel color inside the shader is setup.
...
{
	// The new pixel color pointer is released here.
					  ...
					  ID3D10ShaderResourceView* texture, D3DXVECTOR4 pixelColor)
{
	...
	//The new pixelColor shader variable is set here.
